...
parser.add_argument('--dataset', default='cifar100', help='dataset setting', choices=('cifar100', 'Imagenet-LT', 'iNat18', 'Places-LT', 'nih-cxr-lt','NWPU-LT','cifar10')
)
...
parser.add_argument('--loss_type', default="CE", type=str, help='loss type / method', choices=('CE', 'LDAM', 'BS', 'DEBS', 'Focal','IB','IBFocal','EBSLDAM'))
parser.add_argument('--loss2', default="GCPLoss", type=str, help='loss type / method')

parser.add_argument('--train_rule', default='None', type=str, help='data sampling strategy for train loader',
                    choices=('None', 'CBReweight', 'DRW','IBReweight'))
...
parser.add_argument('--feat_dim', type=int, default=64, help="feat_dim")


# data augmentation setting
parser.add_argument('--data_aug', default="CMeO", type=str, help='data augmentation type',
                    choices=('vanilla', 'CMO'))
...
parser.add_argument('--use_randaug',default=False, action='store_true')
